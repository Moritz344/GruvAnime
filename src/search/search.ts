...
export class Search implements OnInit, AfterContentInit {
  ...
  statusManga: { name: string; value: string }[] = [
  ...
  genres: { name: string; value: string }[] = [
    ...
    { name: 'Ecchi', value: '9' },
    { name: 'Erotica', value: '49' },
    { name: 'Hentai', value: '12' },
    { name: 'Adult Cast', value: '50' },
    { name: 'Anthropomorphic', value: '51' },
    { name: 'CGDCT', value: '52' },
    { name: 'Childcare', value: '53' },
    { name: 'Combat Sports', value: '54' },
    { name: 'Crossdressing', value: '81' },
    { name: 'Delinquents', value: '55' },
    { name: 'Detective', value: '39' },
    { name: 'Educational', value: '56' },
    { name: 'Gag Humor', value: '57' },
    { name: 'Gore', value: '58' },
    { name: 'Harem', value: '35' },
    { name: 'High Stakes Game', value: '59' },
    { name: 'Historical', value: '13' },
    { name: 'Idols (Female)', value: '60' },
    { name: 'Idols (Male)', value: '61' },
    { name: 'Isekai', value: '62' },
    { name: 'Iyashikei', value: '63' },
    { name: 'Love Polygon', value: '64' },
    { name: 'Magical Sex Shift', value: '65' },
    { name: 'Mahou Shoujo', value: '66' },
    { name: 'Martial Arts', value: '17' },
    { name: 'Mecha', value: '18' },
    { name: 'Medical', value: '67' },
    { name: 'Military', value: '38' },
    { name: 'Music', value: '19' },
    { name: 'Mythology', value: '6' },
    { name: 'Organized Crime', value: '68' },
    { name: 'Otaku Culture', value: '69' },
    { name: 'Parody', value: '20' },
    { name: 'Performing Arts', value: '70' },
    { name: 'Pets', value: '71' },
    { name: 'Psychological', value: '40' },
    { name: 'Racing', value: '3' },
    { name: 'Reincarnation', value: '72' },
    { name: 'Reverse Harem', value: '73' },
    { name: 'Love Status Quo', value: '74' },
    { name: 'Samurai', value: '21' },
    { name: 'School', value: '23' },
    { name: 'Showbiz', value: '75' },
    { name: 'Space', value: '29' },
    { name: 'Strategy Game', value: '11' },
    { name: 'Super Power', value: '31' },
    { name: 'Survival', value: '76' },
    { name: 'Team Sports', value: '77' },
    { name: 'Time Travel', value: '78' },
    { name: 'Vampire', value: '32' },
    { name: 'Video Game', value: '79' },
    { name: 'Visual Arts', value: '80' },
    { name: 'Workplace', value: '48' },
    { name: 'Urban Fantasy', value: '82' },
    { name: 'Villainess', value: '83' },
    { name: 'Josei', value: '43' },
    { name: 'Kids', value: '15' },
  ...
  order_by: { name: string; value: string }[] = [
  ...
  order_by_manga: { name: string; value: string }[] = [
    { name: 'Title', value: 'title' },
    { name: 'Start Date', value: 'start_date' },
    { name: 'End Date', value: 'end_date' },
    { name: 'Score', value: 'score' },
    ...
    { name: 'Favourites', value: 'favourties' },
  ...
  constructor(
    ...
    this.searchSubject.pipe(debounceTime(this.searchCooldown)).subscribe(() => {
      this.performSearch();
    });
  }
